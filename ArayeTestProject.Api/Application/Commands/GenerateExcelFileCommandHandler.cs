...
namespace ArayeTestProject.Api.Application.Commands {
    public class GenerateExcelFileCommandHandler : IRequestHandler<GenerateExcelFileCommand, GenerateExcelFileResource> {
        private readonly IHostingEnvironment hostingEnvironment;
        private readonly IHttpContextAccessor httpContext;

        public GenerateExcelFileCommandHandler (IHostingEnvironment hostingEnvironment, IHttpContextAccessor httpContext) {
            this.hostingEnvironment = hostingEnvironment;
            this.httpContext = httpContext;
        }

        public Task<GenerateExcelFileResource> Handle (GenerateExcelFileCommand request, CancellationToken cancellationToken) {
            ...
            using (var fs = new FileStream (filePath, FileMode.Create, FileAccess.Write)) {
                ...
                var sale = new Faker<Sale> (locale: "fa")
                    ...
                    .RuleFor (s => s.ProductId, opt => opt.Random.Int (0, 10000))
